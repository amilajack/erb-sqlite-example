...
const newsFeedOptions = [
  ...
  <Row key={idx}>
    ...
    {newsFeedOptionsKeyEdited.includes(o.key) ? (
      <a>
...
const friendOptions = [
  ...
  <Row key={idx}>
    <Checkbox value={o.key}>{o.value}</Checkbox>
    {friendOptionsKeyEdited.includes(o.key) ? (
      <a>
        <EditOutlined onClick={() => {}} />
      </a>
    ) : null}
...
const groupOptions = [
  ...
  <Row key={idx}>
  <Checkbox value={o.key}>{o.value}</Checkbox>
    {groupOptionsKeyEdited.includes(o.key) ? (
      <a>
        <EditOutlined onClick={() => {}} />
      </a>
    ) : null}
...
const profileOptionsFirst = [
  ...
  <Row key={idx}>
    <Checkbox value={o.key}>{o.value}</Checkbox>
    {profileOptionsKeyEdited.includes(o.key) ? (
      <a>
        <EditOutlined onClick={() => {}} />
      </a>
    ) : null}
...
const mixOptions = [
  ...
  <Row key={idx}>
    <Checkbox value={o.key}>{o.value}</Checkbox>
    {mixOptionsKeyEdited.includes(o.key) ? (
      <a>
        <EditOutlined onClick={() => {}} />
      </a>
    ) : null}
...
const pageOptions = [
  ...
  <Row key={idx}>
    <Checkbox value={o.key}>{o.value}</Checkbox>
    {pageOptionsKeyEdited.includes(o.key) ? (
      <a>
        <EditOutlined onClick={() => {}} />
      </a>
    ) : null}
    ...
    >
      ...
      <Row>
        ...
        <Col span={6}>
          ...
          <Checkbox.Group onChange={onChangeNewsFeed}>
            <Row>
              <Col style={{ marginRight: '10px' }}>{profileOptionsFirst}</Col>
              <Col>{profileOptionsSecond}</Col>
            </Row>
          </Checkbox.Group>
        </Col>
        <Col span={3}>
